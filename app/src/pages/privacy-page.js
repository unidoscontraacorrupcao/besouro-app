...
class PrivacyPage extends PolymerElement {
  static get template() {
    ...
    <div class="content">
      ...
      <p><strong>POLÍTICA DE PRIVACIDADE E TERMOS DE USO TRANSPARÊNCIA INTERNACIONAL BRASIL</strong><br>
      A ASSOCIAÇÃO TRANSPARÊNCIA E INTEGRIDADE, conhecida como “Transparência Internacional Brasil”, é uma associação brasileira, sem fins lucrativos e de caráter filantrópico, inscrita sob CNPJ no 26.219.946/0001-37 e regulamentada de acordo com o Código Civil Brasileiro (artigos 44 a 69).</p>
      ...
      <p><strong>UTILIZAÇÃO DAS INFORMAÇÕES</strong><br>
      Ao se cadastrar em uma lista da Transparência Internacional Brasil, podemos enviar e-mails, cartas e mensagens de texto (SMS) para fins de mobilização, divulgação e captação de recursos da própria Transparência Internacional Brasil ou de projetos que apoiamos.</p>
      ...
      <p><strong>ENVIO DE MENSAGENS DE TEXTO (SMS)</strong><br>
      ...
      <p><strong>ACESSO AOS SEUS DADOS</strong><br>
      Você pode solicitar uma cópia dos seus dados a qualquer momento, através do e-mail relacionamento@transparenciainternacional.org.br. No entanto, esses dados precisam ser solicitados por você e não serão entregues a parentes ou assessores/secretários.</p>

      <p><strong>SEGURANÇA DA INFORMAÇÃO</strong><br>
      Todos os dados em poder da Transparência Internacional Brasil são armazenados em servidores seguros e criptografados, cujo acesso só é permitido a funcionários da Transparência Internacional Brasil capacitados a gerenciá-los com segurança ou fornecedores com contratos de confidencialidade.</p>
      ...
      <p><strong>EXCLUSÃO DE DADOS</strong><br>
      ...
      A Transparência Internacional Brasil está presente na seguinte rede social:</p>
      ...
      GERAL<br>
      Política de Privacidade atualizada em 25/05/2018.</p>
